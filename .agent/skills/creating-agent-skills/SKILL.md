...
description: Assists in creating high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user wants to build a new skill or automate a specific task using the skill system.
---

# Gemini Skill Creator (Antigravity Skill Creator)
