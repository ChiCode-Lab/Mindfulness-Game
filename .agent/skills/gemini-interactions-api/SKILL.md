---
name: using-gemini-interactions
description: Assists with writing code that calls the Gemini API Interactions API for text generation, multi-turn chat, deep research agents, and background execution. Use when the user needs help with stateful conversations, tool orchestration, or migrating from generateContent.
---
