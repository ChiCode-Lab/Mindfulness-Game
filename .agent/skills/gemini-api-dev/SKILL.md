---
name: developing-with-gemini
description: Provides guidance for building applications with the Gemini API and models. Use when the user needs help with multimodal content, function calling, structured outputs, or SDK usage (google-genai, @google/genai, Java, Go).
---
