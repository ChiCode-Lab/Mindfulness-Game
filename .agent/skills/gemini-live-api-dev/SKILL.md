---
name: developing-with-gemini-live
description: Provides guidance for building real-time, bidirectional streaming applications with the Gemini Live API. Use when the user mentions Live API, WebSockets, voice interactions, VAD, or streaming with Gemini.
---
